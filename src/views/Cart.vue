      ...
      <div v-if="addedPizzas.length" class="cart">
        ...
        <div class="cart__bottom">
          <div class="cart__bottom-details">
            <span>
              Всего пицц: <b>{{ getTotalCount }} шт.</b>
            </span>
            <span>
...
export default {
  ...
  setup() {
    ...
    const addedPizzas = computed(() => {
      return Object.values(store.state.cart.items);
    });

    const getTotalPrice = computed(() => store.getters.getTotalPrice);
    const getTotalCount = computed(() => store.getters.getTotalCount);

    return { addedPizzas, getTotalPrice, getTotalCount };
  },
};
</script>
